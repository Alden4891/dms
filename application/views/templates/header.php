...
<head>
  ...
  <title>DIMS Beta | DSWD XII</title>
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="<?=site_url('assets')?>/dist/img/AdminLTELogo.png" alt="AdminLTELogo" height="125" width="450"><br>
    <p class="animation__shake"><h1><i>Document Digitalization and Indexing System</i></h1></p>
  </div>
