    ...
    <section class="content">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title">Catalogue of Routed Documents</h3>
                ...
                <div class="col-12 col-sm-4">
                  <div class="info-box bg-light">
                    <div class="info-box-content">
                      ...
                      <span class="info-box-number text-center text-muted mb-0"><h2><?=$route_count?></h2></span>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-4">
                  <div class="info-box bg-light">
                    <div class="info-box-content">
                      <span class="info-box-text text-center text-muted">Routes with responses</span>
                      <span class="info-box-number text-center text-muted mb-0"><h2><?=$route_responsed?></h2></span>
                    </div>
                  </div>
                </div>
                <div class="col-12 col-sm-4">
